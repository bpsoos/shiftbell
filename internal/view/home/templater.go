...
func (t *Templater) Home(offset int, limit int, chores *models.GetChoreTypeBatchResult, ctx context.Context, w io.Writer) error {
	return home(offset, limit, chores).Render(ctx, w)
}
