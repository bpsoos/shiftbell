...
1 rename chore types to chore templates in the endpoint and view layers
2 rename chore types to chore templates in models, routing, and application wiring
